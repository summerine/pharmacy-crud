...
<div class="container-fluid">
	...
	<div class="row">
		...
		<div class="container-fluid">
			...
			<div class="container-fluid">
			<div class="row">
				<a href="#addnew" data-toggle="modal" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Add Obat</a>
			</div>
		</div>
			<div class="container-fluid">
			<div class="row">
						...
						<?php
							...
							while($row = mysqli_fetch_assoc($query)){
								...
								"<tr>
							 		...
							 		<td>".$row['stok']."</td>
							 		<td>
							 			<a href='#edit_".$row['id_obat']."' class='btn btn-success btn-sm' data-toggle='modal'><span class='glyphicon glyphicon-edit'></span> Edit</a>

									<a href='#delete_".$row['id_obat']."' class='btn btn-danger btn-sm' data-toggle='modal'><span class='glyphicon glyphicon-trash'></span> Delete</a>
									
									</td>
							 	</tr>";
							 	include('edit_delete_index.php');
							}
						?>
					</tbody>
				</table>
