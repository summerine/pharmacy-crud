...
<div class="container-fluid">
	...
	<div class="row">
		...
		<div class="container-fluid">
			...
			<div class="container-fluid">
			<div class="row">
				<a href="#addnew" data-toggle="modal" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span>Add Golongan</a>
			</div>
		</div>
			<div class="container-fluid">
			<div class="row">
						...
						<?php
							...
							while($row = mysqli_fetch_assoc($query)){
								...
								"<tr>
							 	...
							 	include('edit_delete_golongan.php');
							}
						?>
					</tbody>
				</table>
...
<?php include('golongan_modal.php') ?>
